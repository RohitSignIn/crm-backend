...
const createTicket = async (req, res) => {
  try {
    //req.body has ticket's data, req.user => we are getting this data from middleware for current user who sent this request
...
const getOneTicket = async (req, res) => {
  try {
    //req.body's param has ticket's id
